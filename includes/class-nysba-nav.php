...
class Nysba_Nav {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Nysba_Nav_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'NYSBA_NAV_VERSION' ) ) {
			$this->version = NYSBA_NAV_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'nysba-nav';
	 ...
	 *
	 * - Nysba_Nav_Loader. Orchestrates the hooks of the plugin.
	 * - Nysba_Nav_i18n. Defines internationalization functionality.
	 * - Nysba_Nav_Admin. Defines all hooks for the admin area.
	 * - Nysba_Nav_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-nysba-nav-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-nysba-nav-i18n.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-nysba-nav-public.php';

		$this->loader = new Nysba_Nav_Loader();
	 ...
	 *
	 * Uses the Nysba_Nav_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Nysba_Nav_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Nysba_Nav_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Nysba_Nav_Loader    Orchestrates the hooks of the plugin.
	 */
