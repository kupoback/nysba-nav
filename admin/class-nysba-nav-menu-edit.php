<?php
/**
 * Edits the nav walker of the admin section
 *
 ...
 */
class Nysba_Nav_Menu_Edit extends Walker_Nav_Menu
{
	...
	<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>">
		...
		<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
			...
			<div class="menu-item-actions description-wide submitbox">
				...
				); ?>"><?php _e('Remove'); ?></a> <span class="meta-sep hide-if-no-js"> | </span>
				<a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url(add_query_arg(
					                                                                                                               [
